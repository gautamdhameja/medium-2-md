...
var readAll = function (filePath, frontMatterConfig, slugField, prefixSlug) {
    ...
    const frontMatter = generateFrontMatter(title, subtitle, date, slug, slugField);
...
var generateFrontMatter = function (title, subtitle, date, slug, slugField, tags) {
